...
exports.login = exports.updatePassword = exports.updateEmailAddress = undefined;

var _index = require('../../../../src/index');

// Updates the email address.
var updateEmailAddress = (0, _index.Action)('updateEmailAddress', function (email) {
    return email;
});
...
var updatePassword = (0, _index.Action)('updatePassword', function (password) {
    return password;
});

// Attempts to login with the credentials provided.
var login = (0, _index.Action)('login', function (credentials) {
    (0, _index.Action)('loginRequested', function (f) {
        return f;
    })();

    // Simulate an async action.
    setTimeout(function () {
        (0, _index.Action)('loginCompleted', function () {
            return credentials;
        })();
    }, 1000);
});
...
},{"../../../../src/index":167}],2:[function(require,module,exports){
'use strict';
...
var App = _react2.default.createClass({
    ...
    componentDidMount: function componentDidMount() {
        ...
        _store2.default.subscribe(function (_, store) {
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'p',
                    null,
                    'View the console to see actions that were dispatched.'
                ),
                _react2.default.createElement('img', { className: 'logo', src: 'logo.svg' })
            ),
            _react2.default.createElement(
                'div',
...
},{"./components/LoginForm":3,"./store":6,"react":164,"react-dom":35}],3:[function(require,module,exports){
'use strict';
...
var LoginForm = _react2.default.createClass({
    ...
    onEmailChange: function onEmailChange(e) {
        (0, _login.updateEmailAddress)(e.target.value);
    },


    // Handler for password changes.
    onPasswordChange: function onPasswordChange(e) {
        (0, _login.updatePassword)(e.target.value);
    },
    ...
    render: function render() {
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { className: 'btn btn-primary', disabled: this.props.authorizing, type: 'submit' },
                    'Sign In'
                )
            )
        );
...
},{"../actions/login":1,"react":164}],4:[function(require,module,exports){
'use strict';
...
var AccountReducer = function (_Reducer) {
    _inherits(AccountReducer, _Reducer);

    function AccountReducer(name) {
        _classCallCheck(this, AccountReducer);

        return _possibleConstructorReturn(this, (AccountReducer.__proto__ || Object.getPrototypeOf(AccountReducer)).call(this, name, {}));
    }

    // Reducer function to handle login completion.


    _createClass(AccountReducer, [{
        key: 'loginCompleted',
        value: function loginCompleted(credentials) {
...
},{"../../../../src/index":167}],5:[function(require,module,exports){
'use strict';
...
var LoginReducer = function (_Reducer) {
    _inherits(LoginReducer, _Reducer);

    function LoginReducer(name) {
        _classCallCheck(this, LoginReducer);

        return _possibleConstructorReturn(this, (LoginReducer.__proto__ || Object.getPrototypeOf(LoginReducer)).call(this, name, INTIAL_STATE));
    }

    // Reducer function to update the state with a new email.


    _createClass(LoginReducer, [{
        key: 'updateEmailAddress',
        value: function updateEmailAddress(email) {
...
},{"../../../../src/index":167}],6:[function(require,module,exports){
'use strict';
...
var _login = require('./reducers/login');
...
var accountReducer = new _account2.default('account'); /**
...
var loginReducer = new _login2.default('login');

// Create a new store with all of the reducers.
exports.default = new _index.Store(loginReducer, accountReducer);

},{"../../../src/index":167,"./reducers/account":4,"./reducers/login":5}],7:[function(require,module,exports){
(function (process){
/**
...
},{"./dispatcher":166}],166:[function(require,module,exports){
"use strict";
...
},{"./action":165,"./reducer":168,"./store":169}],168:[function(require,module,exports){
"use strict";
